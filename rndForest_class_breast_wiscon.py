...
import time
# Upload the dataset
diamonds = pd.read_csv('breast-cancer-wisconsin.csv')
diamonds.head()
...
X = diamonds[['Clump_Thickness','Uniformity_Cell_Size', 'Uniformity_Cell_Shape', 'Marginal_Adhesion', 'Single_Epithelial_Cell_Size', 'Bare_Nuclei', 'Bland_Chromatin', 'Normal_Nucleoli', 'Mitoses']]
y = diamonds[['Class']]
